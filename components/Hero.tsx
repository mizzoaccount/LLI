...
export default function Hero() {
  ...
  const backgroundImages = [
    ...
    'https://i.pinimg.com/736x/1a/b3/1f/1ab31f6b0a11297cc0c646cab482f4d5.jpg'
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            {/* Floating cards */}
            <motion.div 
              className="absolute top-20 left-20 bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-2xl w-64 border border-white/20"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.8, duration: 0.6 }}
            >
            ...
            <motion.div 
              className="absolute bottom-20 right-20 bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-2xl w-64 border border-white/20"
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 1.0, duration: 0.6 }}
            >
